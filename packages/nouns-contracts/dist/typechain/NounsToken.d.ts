...
interface NounsTokenInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(functionFragment: "mintTest", values?: undefined): string;
  ...
  decodeFunctionResult(functionFragment: "mintTest", data: BytesLike): Result;
...
export class NounsToken extends Contract {
  ...
  callStatic: {
    ...
    mintTest(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  filters: {
    ...
    NoundersDAOUpdated(
      noundersDAO: null
    ): TypedEventFilter<[string], { noundersDAO: string }>;
